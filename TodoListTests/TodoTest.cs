...
namespace TodoListTests
{
    ...
    public class TodoTest
    {
        ...
        private readonly Todo.Data testowaData = new Todo.Data(new DateTime(2020, 10, 15));
        ...
        private readonly Todo.Data domyslnaData = new Todo.Data(DateTime.Today.AddDays(1));
        ...
        public void KonstruktorZKompletemParametrow()
        {
            ...
            Assert.AreEqual(zKompletemParametrow.Deadline.ToString(), testowaData.ToString());
        ...
        public void KonstruktorBezOpisu()
        {
            ...
            Assert.AreEqual(bezOpisu.Deadline.ToString(), testowaData.ToString());
        ...
        public void KonstruktorBezpisuIPriorytetu()
        {
            ...
            Assert.AreEqual(bezOpisuIPriorytetu.Deadline.ToString(), testowaData.ToString());
        ...
        public void KonstruktorZSamaNazwa()
        {
            ...
            Assert.AreEqual(tylkoNazwa.Deadline.ToString(), domyslnaData.ToString());
        ...
        public void KonstruktorBezParametrow()
        {
            ...
            Assert.AreEqual(bezParametrow.Deadline.ToString(), domyslnaData.ToString());
